document.addEventListener("DOMContentLoaded", function(event){
    ...
    function displayProduct(pProduct, pHtmlName, pHtmlPrice, pImage, pButton){
        ...
        document.getElementById(pButton).addEventListener("click", function(){ addToCart(pProduct)});
    }

        //test displayProduct method on page1
        displayProduct(productList[0], "productName1", "productPrice1", "productImg1", "btnCart1");

    function displayCart(userCart, productList){
    ...
    $(document).on("pagebeforeshow", "#page2", function(){
        displayCart(userCart, productList)
    });
    
    //button test
    //document.getElementById("speakerMinus").addEventListener("click", function(){ alert("shits clicked yo")});
